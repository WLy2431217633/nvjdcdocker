...
国内
```
git clone https://ghproxy.com/https://github.com/WLy2431217633/nvjdcdocker.git /root/nolanjdc
```
国外
```
git clone https://github.com/WLy2431217633/nvjdcdocker.git /root/nolanjdc
```
...
```
wget -O Config.json  https://raw.githubusercontent.com/WLy2431217633/nvjdc/main/Config.json
```
国内请使用
 ```
wget -O Config.json   https://ghproxy.com/https://raw.githubusercontent.com/WLy2431217633/nvjdc/main/Config.json
```
...
```
docker run   --name nolanjdc -p 5704:80 -d  -v  "$(pwd)":/app \
